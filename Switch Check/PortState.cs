...
namespace Switch_Check
{
    public class PortState : MainWindow
    {
        ...
        private static List<string> p24c = new List<string>() { "Cup Labeler", "Seiko Epson Corporation" };
        private static List<string> p25c = new List<string>() { "Cup Labeler", "Seiko Epson Corporation" };
        ...
        private static List<string> p35c = new List<string>() { "Drive Thru Timer", "HM Electronics, Inc." };
        private static List<string> p36c = new List<string>() { "Drive Thru Timer", "Jetway Information Co., Ltd." };
        private static List<string> p37c = new List<string>() { "EMS, Surveyor", "Venstar Inc." };
        private static List<string> p38c = new List<string>() { "None", "Venstar Inc.", "Coffee Equipment Company" };
        private static List<string> p39c = new List<string>() { "None", "Venstar Inc.", "Coffee Equipment Company" };
        ...
        private static List<string> p24a = new List<string>(){ "Cup Labeler", "Seiko Epson Corporation" };
        private static List<string> p25a = new List<string>(){ "Cup Labeler", "Seiko Epson Corporation" };
        ...
        private static List<string> p38a = new List<string>(){ "None", "Venstar Inc.", "Coffee Equipment Company" };
        private static List<string> p39a = new List<string>(){ "None", "Venstar Inc.", "Coffee Equipment Company" };
