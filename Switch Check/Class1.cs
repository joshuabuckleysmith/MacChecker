...
namespace Switch_Check
{
    ...
    class Funks
    {
        ...
        public static Dictionary<int, string> validationdictionary = new Dictionary<int, string>()
            {
            {0 , "Cradlepoint"},
            {1 , "Juniper Switch or Router"},
            {2 , "Aruba AP"},
            {3 , "Cisco Modem"},
            {4 , ""},
            {5 , ""},
            ...
            {44 , ""},
            {45 , ""},
            {46 , "Curio Store Music Player"},
            {47 , "Printer"},
            {48 , "Juniper Switch or Router"}
        };
